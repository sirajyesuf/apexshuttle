...
export default function ContactUs() {
    return (
        <section
            className="h-auto bg-white text-white grid grid-cols-1 md:grid-cols-2 shadow-none rounded-lg  container mx-auto my-12 border-[1px] border-[#e9e9e9]"
        ...
        >
            ...
            <div className="border-t-[1px] md:border-l-[1px] border-[#e9e9e9] rounded-t-lg md:rounded-l-lg">
                <iframe
